    ...
    return (
        <section className="flex flex-col pr-4 pt-10 pb-4 lg:w-[90%] lg:mx-auto">
            ...
            <div className="pt-4 pb-6">
                <h1 className="text-[40px] font-semibold">Isaac</h1>
                <p className="text-[#808080] text-lg text-nowrap">
                    Hello, let&apos;s build today!
                </p>
            </div>
            <section className="flex gap-6 lg:justify-between items-center flex-row">
                <div className="bg-[#E2DDFE] shrink-0 text-center px-4 py-8 rounded-lg md:w-1/2">
            ...
            <section className="flex flex-col">
                <h1 className="text-[33px] font-semibold text-nowrap">
                    Quick Access
                </h1>
                <section className="pt-10 flex gap-10 lg:justify-between">
